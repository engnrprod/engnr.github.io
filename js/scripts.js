...
$(document).ready(function () {
		...
		$('*').bind('mousemove keydown scroll', function () {
				...
				if (idleState == true) {
						...
						// Reactivated event
					//	$(".close").removeClass("user-inactive");
					  $(".btn-ctrl").removeClass("user-inactive");
					  $(".vjs-progress-control").removeClass("user-inactive");
				...
				idleTimer = setTimeout(function () {
						...
						// Idle Event
					//	$(".close").addClass("user-inactive");
					  $(".btn-ctrl").addClass("user-inactive");
					  $(".vjs-progress-control").addClass("user-inactive");
